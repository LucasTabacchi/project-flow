...
export function NavLink({ href, className, children, ...props }: NavLinkProps) {
  ...
  return (
    <Link
      href={href}
      className={cn(
        "focus-ring group flex items-center gap-3 rounded-2xl px-3 py-2 text-sm font-medium text-muted-foreground transition hover:bg-secondary/70 hover:text-foreground",
