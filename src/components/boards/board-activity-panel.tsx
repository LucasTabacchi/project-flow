...
const ACTIVITY_ICONS: Record<string, React.ElementType> = {
  ...
  CARD_DEPENDENCY_ADDED: Link2,
  CARD_DEPENDENCY_REMOVED: X,
...
const ACTIVITY_COLORS: Record<string, string> = {
  ...
  CARD_DEPENDENCY_ADDED: "bg-cyan-500/10 text-cyan-700 dark:text-cyan-300",
  CARD_DEPENDENCY_REMOVED: "bg-rose-500/10 text-rose-700 dark:text-rose-300",
